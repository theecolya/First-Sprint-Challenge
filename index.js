...
const twentysArr = [];
  for (let i = 0; i < array.length; i++) {
   if (array[i].years.includes('1907 - 1954') || array[i].years.includes('1904 - 1989')) {
     twentysArr.push(array[i].name)
    };
  };
  return twentysArr
}
...
function addArtist(array) {
  array.push({
    ...
    bio: 'A baddie in stem, you other snitches could nevah.'
  });
  return array
}
